  ...
  return (
    ...
    >
      <Stack gap="md" align="center">
        ...
        <Text size="xl" fw={700}>Unitree Go2 MuJoCo WASM</Text>
        <Text size="sm" c="dimmed">app version {MJSWAN_VERSION}</Text>
        <Text size="sm" c="dimmed">MuJoCo WebAssembly simulation with ONNX policy control</Text>
        <Divider w="100%" />
        <Box>
    ...
    >
      <FloatingPanel.Handle>
        <Tooltip label={`Go2 Web ${MJSWAN_VERSION}`}>
          <Box
            component="a"
